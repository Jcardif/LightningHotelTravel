...
namespace LightningHotelTravel.Dialogs
{
    public class FlightBookingDialog : CancelAndHelpDialog
    {
        ...
        {
            var bookingDetails = (FlightBookingDetails) stepContext.Options;
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var promptMessage =
                    MessageFactory.Text(OriginStepMsgText, OriginStepMsgText, InputHints.ExpectingInput);
                return await stepContext.PromptAsync(nameof(TextPrompt), new PromptOptions {Prompt = promptMessage},
                    cancellationToken);
            }
            ...
            CancellationToken cancellationToken)
        {
            ...
            var messageText =
                $"Please confirm, I have you traveling to: {bookingDetails.Destination} from: {bookingDetails.Origin} on: {bookingDetails.TravelDate}. Is this correct?";
