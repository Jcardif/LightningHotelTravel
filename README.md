...
- In a terminal, navigate to `LightningHotelTravel`

    ```bash
    # change into project folder
    cd LightningHotelTravel
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `LightningHotelTravel` folder
  - Select `LightningHotelTravel.csproj` file
